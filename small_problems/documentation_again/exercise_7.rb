...
this includes not only those methods defined in the String class, but also methods that are inherited from Object (which inherits other methods from the BasicObject class and the Kernel module). 
...
# I had no clue where to look, the answer is:
# puts s.public_methods(false).inspect
# Look in the Parent's methods! 
